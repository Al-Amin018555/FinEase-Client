                    ...
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)} className="fieldset">
                            ...
                            <div className="relative">
                                ...
                                />
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="p-3 absolute right-5">
                                    {
                            ...
                            <button type="button" onClick={handleGoogleLogin} className="btn bg-base-100 text-black border-info">
